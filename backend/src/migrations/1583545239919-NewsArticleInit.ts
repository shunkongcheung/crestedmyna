...
export class NewsArticleInit1583545239919 implements MigrationInterface {
    name = 'NewsArticleInit1583545239919'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "news_article" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT LOCALTIMESTAMP, "updatedAt" TIMESTAMP NOT NULL DEFAULT LOCALTIMESTAMP, "sourceId" character varying NOT NULL, "sourceName" character varying NOT NULL, "author" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "url" character varying NOT NULL, "urlToImage" character varying NOT NULL, "publishedAt" character varying NOT NULL, "content" character varying NOT NULL, "createdById" integer, CONSTRAINT "UQ_c8124b9d4eefd9efeb340dd1b6a" UNIQUE ("url"), CONSTRAINT "PK_12e2ec4b5482dadc50ee88e0da1" PRIMARY KEY ("id"))`, undefined);
